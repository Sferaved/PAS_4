package com.taxi_pas_4.utils.exit;
...
public class ServerOutageHelperTest {
    ...
    public void anrProcessSuffix_isAnrProcess() {
        assertTrue(ServerOutageHelper.isAnrProcessName("com.taxi_pas_4:anr"));
        assertFalse(ServerOutageHelper.isAnrProcessName("com.taxi_pas_4"));
