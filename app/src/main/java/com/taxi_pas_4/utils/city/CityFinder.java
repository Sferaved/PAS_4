...
//                            break;
    ...
    private void cityMaxPay(String city) {
        ...
        Call<com.taxi_pas_4.cities.api.CityResponse> call = cityService.getMaxPayValues(city, context.getString(R.string.application));

        call.enqueue(new Callback<com.taxi_pas_4.cities.api.CityResponse>() {
            @Override
            public void onResponse(@NonNull Call<com.taxi_pas_4.cities.api.CityResponse> call, @NonNull Response<com.taxi_pas_4.cities.api.CityResponse> response) {
                if (response.isSuccessful()) {
                    com.taxi_pas_4.cities.api.CityResponse cityResponse = response.body();
            ...
            @Override
            public void onFailure(@NonNull Call<com.taxi_pas_4.cities.api.CityResponse> call, @NonNull Throwable t) {
                Logger.d(context, TAG, "Failed. Error message: " + t.getMessage());
            }
        });
    }
