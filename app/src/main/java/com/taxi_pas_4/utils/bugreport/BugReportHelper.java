package com.taxi_pas_4.utils.bugreport;
...
import com.taxi_pas_4.utils.bugreport.mantis.MantisBugReportSender;
...
public class BugReportHelper {
    ...
    private void sendReportWithDescription(String baseReport, String description, String steps, String expected, String actual,
        ...
        // Краткое сообщение для Telegram формируется после создания тикета в Mantis.
