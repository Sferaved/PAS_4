        ...
        try {
            ...
            if (jsonResponse.has("features")) {
                ...
                for (int i = 0; i < features.length(); i++) {
                    ...
                    if (!com.taxi_pas_4.utils.visicom.VisicomFeatureJsonHelper.hasFeatureItemFields(feature)) {
                        continue;
                    }
...
//                                        coordinatesList.add(new double[]{longitude, latitude});
                ...
                if (com.taxi_pas_4.utils.visicom.VisicomFeatureJsonHelper.hasRootFeatureFields(jsonResponse)) {
...
//        }
    ...
    private void visicomKey() {
        com.taxi_pas_4.ui.visicom.visicom_search.key_visicom.ApiClient.getVisicomKeyInfo(new Callback<>() {
            @Override
