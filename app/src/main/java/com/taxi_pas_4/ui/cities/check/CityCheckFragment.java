package com.taxi_pas_4.ui.cities.check;
...
public class CityCheckFragment extends Fragment {
    ...
    View root;
    private final MovingCityButtonIndicator testCityIndicator = new MovingCityButtonIndicator();
