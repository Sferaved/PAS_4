...
import com.taxi_pas_4.utils.network.GsonResponseParser;
...
public class WeatherApiHelper {
    ...
    public static String getApiKey(Context context) {
        ...
        if (com.taxi_pas_4.MainActivity.weatherKey != null &&
                !com.taxi_pas_4.MainActivity.weatherKey.isEmpty()) {
            return com.taxi_pas_4.MainActivity.weatherKey;
        }
